  ...
  function s(e) {
    1 == t("#light-mode-switch").prop("checked") && "light-mode-switch" === e
      ? (t("html").removeAttr("dir"),
        ...
        t("#bootstrap-style").attr("href", "veltrix/css/bootstrap.min.css"),
        t("#app-style").attr("href", "veltrix/css/app.min.css"),
      ...
      : 1 == t("#rtl-mode-switch").prop("checked") &&
        ...
        (t("#light-mode-switch").prop("checked", !1),
        t("#dark-mode-switch").prop("checked", !1),
        t("#bootstrap-style").attr("href", "veltrix/css/bootstrap-rtl.min.css"),
        t("#app-style").attr("href", "veltrix/css/app-rtl.min.css"),
        t("html").attr("dir", "rtl"),
        document.body.setAttribute("data-bs-theme", "light"),
        document.body.setAttribute("data-topbar", "light"),
